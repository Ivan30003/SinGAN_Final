...
def test_result_image():
    ...
    parser.add_argument('--result-image-path', default='', help='if you launched model you should go to dir "results"')
    ...
    image_1 = cv.imread(args.result_image_path)
    image_2 = cv.imread(args.checking_image_path)
