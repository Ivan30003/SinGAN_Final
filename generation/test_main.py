...
from test_result_image import test_result_image
...
def get_arguments():
    ...
    parser.add_argument('--root', default='images/balloons.png', help='image source')
    ...
    parser.add_argument('--num-steps', default=10, type=int, help='number of steps per scale (default: 4000)')
    ...
    parser.add_argument('--seed', default=37123, type=int, help='random seed (default: random)')
    ...
    parser.add_argument('--save', metavar='SAVE', default='result_images', help='saved folder')
    parser.add_argument('--evaluation', default=True, action='store_true', help='evaluate a model')
    parser.add_argument('--model-to-load', default='results/g_multivanilla.pt',
                        help='evaluating from file (default: None)')
    parser.add_argument('--amps-to-load', default='results/amps.pt', help='evaluating from file (default: None)')
